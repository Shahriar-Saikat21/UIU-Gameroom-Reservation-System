const carromSearch = document.querySelector('.carromSearch');
const section3 = document.querySelector('.section3');
let dateSearch = "";
let board = "";

carromSearch.addEventListener('click', (e)=>{
    e.preventDefault();
    ...
    if(difference < 0){
      ...
      window.location.href = '/studentCarrom';
      ...
      .then(data =>{
          ...
          <div class="form-row d-flex justify-content-center">
            <button class="btn btn-color w-50 m-4 " type="button" onclick="reserveCarrom()">Reserve</button>
          </div>
        </div>        
          `;
          section3.insertAdjacentHTML('beforeend',markup);
      }).catch(err=>{
