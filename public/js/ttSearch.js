const ttSearch = document.querySelector('.ttSearch');
const section2 = document.querySelector('.section2');
let dateSearch = "";
let board = "";

ttSearch.addEventListener('click', (e)=>{
    e.preventDefault();
    ...
    if(difference < 0){
        ...
        window.location.href = '/studentTableTennis';
      ...
      .then(data =>{
          ...
          <div class="form-row d-flex justify-content-center">
            <button class="btn btn-color w-50 m-4 " type="button" onclick="reserveTT()">Reserve</button>
          </div>
        </div>        
          `;
          section2.insertAdjacentHTML('beforeend',markup);
      }).catch(err=>{
